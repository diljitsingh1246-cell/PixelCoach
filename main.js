...
// ═══════════════════════════════════════════════════════════
/**
 * Renders a video into a specific container
 * @param {string} videoId - The YouTube ID or local path
 * @param {boolean} isLocal - Flag from your data.js
 * @param {string} containerId - The ID of the div where the video should appear
 */
function renderVideoPlayer(videoId, isLocal, containerId) {
    ...
    if (isLocal) {
        // Render standard HTML5 Video Player for local files
        playerHTML = `
        ...
        // Render YouTube Embed for IDs
        // parameters: rel=0 (no related videos), modestbranding=1 (cleaner look)
